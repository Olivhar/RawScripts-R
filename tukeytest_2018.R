...
# Définition des parametres a comparer (selon le nom des colonnes)
...
for(i in mypara1[1:37]){      ##Préciser de 1:37 pour les données GC
...
# Suc$Name <- Suc$Espece ####Faire modif si anova par especes ou définir les groupes si autres segment
